      ...
      <section className="body-copy">
        <div className="content">
          ...
          <p>
            ...
            and the Holy Spirit; as described in the Holy Bible is our true sovereign.
          </p>
          <p>
            <strong>Imago Dei</strong> — We are all individually created in God’s
            image, so we soundly reject secular humanism, collectivism, and
            advocates or adherents to the supremacy of one group of people
          ...
          <p>
            <strong>Liberty</strong> — Individual liberty is the cornerstone
            of our republic, which we must defend with our lives, our
          ...
          <p>
            ...
            of speech, freedom of association, freedom in religion, the
            right to bear arms, the right to acquire and own property,
            and the right to engage in the pursuit of happiness.
          </p>
          <p>
          ...
          <p>
            ...
            designed to enshrine and protect sacred negative rights to be equally
            administered, free of judicial activism.
          </p>
          <p>
            <strong>Marriage</strong> — The union of one man and one woman is
            the cornerstone of family, community, and nation; thus it is sacrosanct.
          </p>
          <p>
          ...
          <p>
            ...
            centralized federal government should therefore be strictly
            and carefully limited.
          </p>
          <p>
            <strong>Fiscal Responsibility</strong> — Government at all levels
            should adhere to the principles of low taxation, maintaining a balanced
            budget, and opposing pork barrel spending so as not to infringe upon the
